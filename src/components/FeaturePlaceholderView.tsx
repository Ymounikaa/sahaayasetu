...
export default function FeaturePlaceholderView({
  ...
  // Translation safety-net for legacy hardcoded UI strings in this feature view.
  // This deliberately changes text only; it does not alter layout, navigation, data, or behavior.
  useEffect(() => {
    const dictionaries: Record<string, Record<string, string>> = {
      hi: {
        'METHOD 1':'तरीका 1','Select symptoms that you feel:':'अपने महसूस होने वाले लक्षण चुनें:','METHOD 2':'तरीका 2','Describe other health problems:':'अन्य स्वास्थ्य समस्याओं का वर्णन करें:','Describe any other symptoms...':'अन्य लक्षणों का वर्णन करें...','METHOD 3':'तरीका 3','Talk / Speak verbally:':'बोलकर बताएं:','Describe what you feel using your phone microphone.':'अपने फोन के माइक्रोफोन से बताएं कि आप कैसा महसूस कर रहे हैं।','Tap to start recording':'रिकॉर्डिंग शुरू करने के लिए टैप करें','Analyze Symptoms':'लक्षणों का विश्लेषण करें',
        'PRESCRIBED DRUG':'निर्धारित दवा','Dosage:':'खुराक:','Dosage':'खुराक','Schedule':'समय-सारणी','Food Relation':'भोजन संबंध','Duration':'अवधि','PATIENT INSTRUCTION:':'रोगी के लिए निर्देश:','Listen Dose':'खुराक सुनें','Morning & Night':'सुबह और रात','Morning, Afternoon & Night':'सुबह, दोपहर और रात','After Food':'भोजन के बाद','Before Food':'भोजन से पहले','1 tablet':'1 गोली','1 capsule':'1 कैप्सूल','5 Days':'5 दिन','7 Days':'7 दिन',
        'Date & Time:':'दिनांक और समय:','Venue:':'स्थान:','benefits:':'लाभ:','Benefits:':'लाभ:','Call':'कॉल करें','Register':'पंजीकरण करें','Registered':'पंजीकृत','Registered NGO Camps':'पंजीकृत एनजीओ शिविर','Your Registered NGO Camps':'आपके पंजीकृत एनजीओ शिविर','Free Diabetic & Eye Checkup':'निःशुल्क मधुमेह और नेत्र जांच','Vaccination drive & free iron supplements':'टीकाकरण अभियान और निःशुल्क आयरन सप्लीमेंट',
        'Registered Patient Phone':'पंजीकृत रोगी का फोन','Blood Group':'रक्त समूह','Vaccine Slip':'टीकाकरण पर्ची','Fully Vaccinated (3 Doses)':'पूर्ण टीकाकरण (3 खुराक)','Uploaded medical documents:':'अपलोड किए गए चिकित्सा दस्तावेज:','Delete':'हटाएं','Click to upload report photos':'रिपोर्ट की तस्वीरें अपलोड करने के लिए क्लिक करें','Supports JPG, PNG, PDF up to 5MB':'JPG, PNG, PDF अधिकतम 5MB तक समर्थित','Morning':'सुबह','Afternoon':'दोपहर','Night':'रात','Days':'दिन','Day':'दिन'
      },
      te: {
        'METHOD 1':'విధానం 1','Select symptoms that you feel:':'మీకు అనిపిస్తున్న లక్షణాలను ఎంచుకోండి:','METHOD 2':'విధానం 2','Describe other health problems:':'ఇతర ఆరోగ్య సమస్యలను వివరించండి:','Describe any other symptoms...':'ఇతర లక్షణాలను వివరించండి...','METHOD 3':'విధానం 3','Talk / Speak verbally:':'మాట్లాడి చెప్పండి:','Describe what you feel using your phone microphone.':'మీ ఫోన్ మైక్రోఫోన్ ఉపయోగించి మీకు ఎలా అనిపిస్తుందో చెప్పండి.','Tap to start recording':'రికార్డింగ్ ప్రారంభించడానికి నొక్కండి','Analyze Symptoms':'లక్షణాలను విశ్లేషించండి',
        'PRESCRIBED DRUG':'సూచించిన మందు','Dosage:':'మోతాదు:','Dosage':'మోతాదు','Schedule':'సమయ పట్టిక','Food Relation':'ఆహార సంబంధం','Duration':'వ్యవధి','PATIENT INSTRUCTION:':'రోగికి సూచనలు:','Listen Dose':'మోతాదు వినండి','Morning & Night':'ఉదయం మరియు రాత్రి','Morning, Afternoon & Night':'ఉదయం, మధ్యాహ్నం మరియు రాత్రి','After Food':'భోజనం తర్వాత','Before Food':'భోజనం ముందు','1 tablet':'1 మాత్ర','1 capsule':'1 క్యాప్సూల్','5 Days':'5 రోజులు','7 Days':'7 రోజులు',
        'Date & Time:':'తేదీ & సమయం:','Venue:':'వేదిక:','benefits:':'ప్రయోజనాలు:','Benefits:':'ప్రయోజనాలు:','Call':'కాల్ చేయండి','Register':'నమోదు చేయండి','Registered':'నమోదైంది','Registered NGO Camps':'నమోదైన NGO శిబిరాలు','Your Registered NGO Camps':'మీరు నమోదు చేసిన NGO శిబిరాలు','Free Diabetic & Eye Checkup':'ఉచిత మధుమేహం & కంటి పరీక్ష','Vaccination drive & free iron supplements':'టీకా కార్యక్రమం & ఉచిత ఐరన్ సప్లిమెంట్లు',
        'Registered Patient Phone':'నమోదైన రోగి ఫోన్','Blood Group':'రక్త గ్రూప్','Vaccine Slip':'టీకా స్లిప్','Fully Vaccinated (3 Doses)':'పూర్తిగా టీకాలు పొందారు (3 మోతాదులు)','Uploaded medical documents:':'అప్‌లోడ్ చేసిన వైద్య పత్రాలు:','Delete':'తొలగించండి','Click to upload report photos':'రిపోర్ట్ ఫోటోలు అప్‌లోడ్ చేయడానికి క్లిక్ చేయండి','Supports JPG, PNG, PDF up to 5MB':'JPG, PNG, PDF గరిష్టంగా 5MB వరకు మద్దతు','Morning':'ఉదయం','Afternoon':'మధ్యాహ్నం','Night':'రాత్రి','Days':'రోజులు','Day':'రోజు'
      },
      ta: {
        'METHOD 1':'முறை 1','Select symptoms that you feel:':'நீங்கள் உணரும் அறிகுறிகளைத் தேர்ந்தெடுக்கவும்:','METHOD 2':'முறை 2','Describe other health problems:':'பிற உடல்நலப் பிரச்சினைகளை விவரிக்கவும்:','Describe any other symptoms...':'பிற அறிகுறிகளை விவரிக்கவும்...','METHOD 3':'முறை 3','Talk / Speak verbally:':'பேசி தெரிவிக்கவும்:','Describe what you feel using your phone microphone.':'உங்கள் தொலைபேசி மைக்ரோஃபோனைப் பயன்படுத்தி நீங்கள் உணர்வதைச் சொல்லுங்கள்.','Tap to start recording':'பதிவைத் தொடங்க தட்டவும்','Analyze Symptoms':'அறிகுறிகளை பகுப்பாய்வு செய்க',
        'PRESCRIBED DRUG':'பரிந்துரைக்கப்பட்ட மருந்து','Dosage:':'அளவு:','Dosage':'அளவு','Schedule':'அட்டவணை','Food Relation':'உணவு தொடர்பு','Duration':'கால அளவு','PATIENT INSTRUCTION:':'நோயாளி வழிமுறை:','Listen Dose':'மருந்தளவை கேளுங்கள்','Morning & Night':'காலை மற்றும் இரவு','Morning, Afternoon & Night':'காலை, மதியம் மற்றும் இரவு','After Food':'உணவுக்குப் பிறகு','Before Food':'உணவுக்கு முன்','1 tablet':'1 மாத்திரை','1 capsule':'1 காப்ஸ்யூல்','5 Days':'5 நாட்கள்','7 Days':'7 நாட்கள்',
        'Date & Time:':'தேதி & நேரம்:','Venue:':'இடம்:','benefits:':'நன்மைகள்:','Benefits:':'நன்மைகள்:','Call':'அழைக்கவும்','Register':'பதிவு செய்யவும்','Registered':'பதிவு செய்யப்பட்டது','Registered NGO Camps':'பதிவு செய்யப்பட்ட NGO முகாம்கள்','Your Registered NGO Camps':'நீங்கள் பதிவு செய்த NGO முகாம்கள்','Free Diabetic & Eye Checkup':'இலவச நீரிழிவு & கண் பரிசோதனை','Vaccination drive & free iron supplements':'தடுப்பூசி முகாம் & இலவச இரும்புச் சத்து மாத்திரைகள்',
        'Registered Patient Phone':'பதிவு செய்யப்பட்ட நோயாளி தொலைபேசி','Blood Group':'இரத்த வகை','Vaccine Slip':'தடுப்பூசி சீட்டு','Fully Vaccinated (3 Doses)':'முழுமையாக தடுப்பூசி பெற்றவர் (3 டோஸ்)','Uploaded medical documents:':'பதிவேற்றப்பட்ட மருத்துவ ஆவணங்கள்:','Delete':'நீக்கு','Click to upload report photos':'அறிக்கை படங்களை பதிவேற்ற கிளிக் செய்யவும்','Supports JPG, PNG, PDF up to 5MB':'JPG, PNG, PDF அதிகபட்சம் 5MB வரை ஆதரவு','Morning':'காலை','Afternoon':'மதியம்','Night':'இரவு','Days':'நாட்கள்','Day':'நாள்'
      },
      kn: {
        'METHOD 1':'ವಿಧಾನ 1','Select symptoms that you feel:':'ನೀವು ಅನುಭವಿಸುವ ಲಕ್ಷಣಗಳನ್ನು ಆಯ್ಕೆಮಾಡಿ:','METHOD 2':'ವಿಧಾನ 2','Describe other health problems:':'ಇತರ ಆರೋಗ್ಯ ಸಮಸ್ಯೆಗಳನ್ನು ವಿವರಿಸಿ:','Describe any other symptoms...':'ಇತರ ಲಕ್ಷಣಗಳನ್ನು ವಿವರಿಸಿ...','METHOD 3':'ವಿಧಾನ 3','Talk / Speak verbally:':'ಮಾತನಾಡಿ ತಿಳಿಸಿ:','Describe what you feel using your phone microphone.':'ನಿಮ್ಮ ಫೋನ್ ಮೈಕ್ರೋಫೋನ್ ಬಳಸಿ ನಿಮಗೆ ಹೇಗೆ ಅನಿಸುತ್ತದೆ ಎಂದು ತಿಳಿಸಿ.','Tap to start recording':'ರೆಕಾರ್ಡಿಂಗ್ ಪ್ರಾರಂಭಿಸಲು ಟ್ಯಾಪ್ ಮಾಡಿ','Analyze Symptoms':'ಲಕ್ಷಣಗಳನ್ನು ವಿಶ್ಲೇಷಿಸಿ',
        'PRESCRIBED DRUG':'ಸೂಚಿಸಿದ ಔಷಧಿ','Dosage:':'ಮಾತ್ರೆ ಪ್ರಮಾಣ:','Dosage':'ಮಾತ್ರೆ ಪ್ರಮಾಣ','Schedule':'ವೇಳಾಪಟ್ಟಿ','Food Relation':'ಆಹಾರ ಸಂಬಂಧ','Duration':'ಅವಧಿ','PATIENT INSTRUCTION:':'ರೋಗಿಗೆ ಸೂಚನೆ:','Listen Dose':'ಮಾತ್ರೆ ಪ್ರಮಾಣ ಕೇಳಿ','Morning & Night':'ಬೆಳಿಗ್ಗೆ ಮತ್ತು ರಾತ್ರಿ','Morning, Afternoon & Night':'ಬೆಳಿಗ್ಗೆ, ಮಧ್ಯಾಹ್ನ ಮತ್ತು ರಾತ್ರಿ','After Food':'ಊಟದ ನಂತರ','Before Food':'ಊಟಕ್ಕೂ ಮೊದಲು','1 tablet':'1 ಮಾತ್ರೆ','1 capsule':'1 ಕ್ಯಾಪ್ಸೂಲ್','5 Days':'5 ದಿನಗಳು','7 Days':'7 ದಿನಗಳು',
        'Date & Time:':'ದಿನಾಂಕ & ಸಮಯ:','Venue:':'ಸ್ಥಳ:','benefits:':'ಪ್ರಯೋಜನಗಳು:','Benefits:':'ಪ್ರಯೋಜನಗಳು:','Call':'ಕರೆ ಮಾಡಿ','Register':'ನೋಂದಣಿ ಮಾಡಿ','Registered':'ನೋಂದಾಯಿಸಲಾಗಿದೆ','Registered NGO Camps':'ನೋಂದಾಯಿತ NGO ಶಿಬಿರಗಳು','Your Registered NGO Camps':'ನೀವು ನೋಂದಾಯಿಸಿದ NGO ಶಿಬಿರಗಳು','Free Diabetic & Eye Checkup':'ಉಚಿತ ಮಧುಮೇಹ & ಕಣ್ಣಿನ ತಪಾಸಣೆ','Vaccination drive & free iron supplements':'ಲಸಿಕಾ ಅಭಿಯಾನ & ಉಚಿತ ಐರನ್ ಪೂರಕಗಳು',
        'Registered Patient Phone':'ನೋಂದಾಯಿತ ರೋಗಿಯ ಫೋನ್','Blood Group':'ರಕ್ತದ ಗುಂಪು','Vaccine Slip':'ಲಸಿಕೆ ಚೀಟಿ','Fully Vaccinated (3 Doses)':'ಸಂಪೂರ್ಣ ಲಸಿಕೆ ಪಡೆದಿದ್ದಾರೆ (3 ಡೋಸ್)','Uploaded medical documents:':'ಅಪ್‌ಲೋಡ್ ಮಾಡಿದ ವೈದ್ಯಕೀಯ ದಾಖಲೆಗಳು:','Delete':'ಅಳಿಸಿ','Click to upload report photos':'ವರದಿ ಫೋಟೋಗಳನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಲು ಕ್ಲಿಕ್ ಮಾಡಿ','Supports JPG, PNG, PDF up to 5MB':'JPG, PNG, PDF ಗರಿಷ್ಠ 5MB ವರೆಗೆ ಬೆಂಬಲ','Morning':'ಬೆಳಿಗ್ಗೆ','Afternoon':'ಮಧ್ಯಾಹ್ನ','Night':'ರಾತ್ರಿ','Days':'ದಿನಗಳು','Day':'ದಿನ'
      }
    };
    const dict = langCode === 'en' ? Object.fromEntries(Object.keys(dictionaries.hi).map(k => [k, k])) : dictionaries[langCode];
    if (!dict) return;
    ...
    const translateText = (value: string) => {
      ...
      let englishCore = core;
      for (const languageDict of Object.values(dictionaries)) {
        const match = Object.entries(languageDict).find(([, translated]) => translated === core);
        if (match) { englishCore = match[0]; break; }
      }
      return dict[englishCore] ? `${lead}${dict[englishCore]}${trail}` : value;
    };
    const apply = () => {
      const walker = document.createTreeWalker(root, NodeFilter.SHOW_TEXT);
      let node: Node | null;
      while ((node = walker.nextNode())) {
        if (node.nodeValue) { const next = translateText(node.nodeValue); if (next !== node.nodeValue) node.nodeValue = next; }
      }
      root.querySelectorAll('input[placeholder], textarea[placeholder]').forEach((el) => {
        const input = el as HTMLInputElement | HTMLTextAreaElement;
        if (input.placeholder && dict[input.placeholder]) input.placeholder = dict[input.placeholder];
      });
    };
    apply();
...
const handleSpeakSymptom = () => {
  ...
  recognition.lang = speechLanguages[langCode] || "en-IN";
  ...
  recognition.onresult = (event: any) => {
    ...
    setTypedSymptom(spokenText);
  };

  recognition.onerror = (event: any) => {
    console.error("Speech recognition error:", event.error);
    setSymptomVoiceActive(false);
    alert("Could not recognize your voice. Please check microphone permission and try again.");
  };
